...
with st.sidebar:
    ...
    st.image("data/IMG-20260226-WA0017-removebg-preview.png", width=250)
    st.markdown("""
<div style='text-align:center ';'margin-right: 7px;'>
...
# Disease Classification Page
    ...
    with col_upload1:
        ...
        uploaded_image = st.file_uploader("Upload medical image", type=['jpg', 'jpeg', 'png'], key="single_image")
